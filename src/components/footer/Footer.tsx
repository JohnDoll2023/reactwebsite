        ...
        <footer className="footer-container">
            ...
            <div className="footer-center">
                <ul className="flex flex-row">
                    ...
                    <li className="mx-2">
                        <a href="https://www.strava.com/athletes/johndoll" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <li className="mx-2" >
                        <a href="https://www.instagram.com/dj_johntherobot/" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 2 24 24"fill="currentColor">
